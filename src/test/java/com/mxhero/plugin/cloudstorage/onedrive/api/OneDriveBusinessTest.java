	...
	public static void beforeClass() throws IOException{
		if(testEnviroment==null){
			try{
				...
				fail(" couldnt read BusinessCredential fro url in SystemProperty test.enviroment.business.json.url with value "+System.getProperty("test.enviroment.business.json.url"));
				e.printStackTrace();
			}
		}
	}
